...
Global music12=LoadSound(soundsdir$ + "music12.mp3")
...
Global energyReversedSnd=LoadSound(soundsdir$ + "energyReversed.wav")
...
Global mkSlideCry2Snd=LoadSound(soundsdir$ + "mk\mkFemaleSlideCry.mp3")
...
Global mkFemaleAgonySnd=LoadSound(soundsdir$ + "mk\mkFemaleAgony.mp3")
Global mkStrongHitSnd=LoadSound(soundsdir$ + "mk\mkStrongHit.wav")
Global mkKickSnd=LoadSound(soundsdir$ + "mk\mkKick.mp3")
Global mkKick2Snd=LoadSound(soundsdir$ + "mk\mkKick2.mp3")
...
Global wwSeriousTimeSnd, wwBlow1Snd, wwAxeSnd, wwAxePlaceSnd
Global wwRoyalThrustStartSnd, wwTiaraThrowSnd, wwTiaraBackSnd, wwTiaraReturnedSnd
...
Global juggGrunt1Snd, juggGrunt2Snd, juggHeadCrushGruntSnd, juggHeadCrushSnd
...
Global piccoloGrunt6Snd, piccoloGrunt7Snd, piccoloGrunt8Snd, piccoloGrunt9Snd
...
Global evilRyuShoryukenSnd, evilRyuHadoukenSnd, evilRyuShinkuuSnd
