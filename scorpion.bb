...
Function performSweepKick(n)
    ...
    If (zBlowSeq(n) => e And zBlowSeq(n) < f) Or (zBlowSeq(n) => ee And zBlowSeq(n) < ff) Then
        ...
        If zBlowSeq(n) >= e And zBlowSeq(n) < f Then
            zHitMode(n)=2:zEnemyImmuneTime(n)=20:zHitSpeed#(n)=3:zHitUpSpeed#(n)=1.5:zHitTime(n)=50
            zBlowDamage(n)=11
        Else
            zBlowDamage(n)=12:zHitMode(n)=0:zEnemyImmuneTime(n)=99
        End If
...
;----- animations -----
    ...
    If zBlowSeq(n)>=f And zBlowSeq(n) < g Then
        zani(n)=22:zf(n)=7
        If zBlowSeq(n) > f+3 And isAttackKeyDown(n)=1 Then zBlowSeq(n)=g
    ...
    If zBlowSeq(n)>=l And zBlowSeq(n) < m Then 
        zani(n)=22:zf(n)=13
        If zBlowSeq(n) > l+3 And isAttackKeyDown(n)=1 Then zBlowSeq(n)=m
...
;----- animations -----
    ...
    If zBlowSeq(n)>=a And zBlowSeq(n) < b Then
        zani(n)=22:zf(n)=15
        If zBlowSeq(n) > a+3 And isAttackKeyDown(n)=1 Then zBlowSeq(n)=b
    ...
    If zBlowSeq(n)>=c And zBlowSeq(n) < d Then
        zani(n)=22:zf(n)=17
        If zBlowSeq(n) > c+3 And isAttackKeyDown(n)=1 Then zBlowSeq(n)=d
...
Case 5    ;Upward Teleport
    ...
    If zBlowSeq(n) >= e And zBlowSeq(n) < f Then 
        ...
        zBlowDamage(n)=5:zBLowEffect(n)=1:zEnemyImmuneTime(n)=40:zBlowStillTime(n)=2:zBlowBlockTime(n)=5
        zBlowSound(n)=mkHitSnd
    End If
    ...
    If zBlowSeq(n) >= g And zBlowSeq(n) < h Then 
        ...
        zHitMode(n)=2:zBlowHold(n)=8
        zHitSpeed#(n)=5:zHitUpSpeed#(n)=3:zHitTime(n)=40
        zBlowDamage(n)=6:zBLowEffect(n)=1:zEnemyImmuneTime(n)=99:zBlowStillTime(n)=2:zBlowBlockTime(n)=5
        zBlowSound(n)=mkHitSnd
    End If
...
Case 7    ;Scorpion Spear
    ...
    If zBlowSeq(n) = c Then
        If spellCooldownSeq(n, 2) > 0 Then spellCooldownMaxTime(n, 2)=80:spellCooldownSeq(n, 2)=spellCooldownMaxTime(n, 2)
        dir=zface(n):y=zy(n)-zheight(n)+18:y2=y-3
...
Case 9    ;Teleport punch
    ...
    If zBlowSeq(n) >= e And zBlowSeq(n) < f Then 
        ...
        zHitMode(n)=2:zBlowHold(n)=8
        zBlowDamage(n)=11:zBLowEffect(n)=1:zEnemyImmuneTime(n)=99:zBlowStillTime(n)=2:zBlowBlockTime(n)=5
    ...
    If zBlowSeq(n) >= g And zBlowSeq(n) < h Then 
        ...
        xblow(n,nn)=10: yblow(n,nn)=28:wblow(n,nn)=21:hblow(n,nn)=1:nn=nn+1
        zHitMode(n)=0:zBlowHold(n)=8
        zBlowDamage(n)=12:zBLowEffect(n)=1:zEnemyImmuneTime(n)=99:zBlowStillTime(n)=2:zBlowBlockTime(n)=5
        zBlowSound(n)=mkHitSnd
    End If
    If zBlowStill(n)=1 Then
        zBlowSeq(n) = i
...
Case 10    ;Up + Attack
    ...
    If zBlowseq(n) > d And zblowseq(n) =< e Then
        ...
        zHitMode(n)=0:zBlowHold(n)=8
        zBlowDamage(n)=14:zBLowEffect(n)=1:zEnemyImmuneTime(n)=99:zBlowStillTime(n)=12:zBlowBlockTime(n)=25
        zBlowSound(n)=mkStrongHitSnd
        zani(n)=14:zf(n)=5
    EndIf
