...
Case 7	; Juggernaut punch (special)
	...
	If zFace(n)=2 Then checkYDist(n,zx(n)+28,zy(n)+6,2)
	If zFace(n)=4 Then checkYDist(n,zx(n)-28,zy(n)+6,2)
;================= Animation ==============
	;=========== Normal Punch =============	
...
;================= Movement ================
	...
	If zBlowSeq(n) >= e2 And zBlowSeq(n) <= f2 And zOnGnd(n) Then moveX(n, zBlowDir(n), 10)
;===========================================
